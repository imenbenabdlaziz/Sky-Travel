...
{
FILE*f;
f=fopen("/home/benabdlazyz/end/src/ajt.txt","a+");
if(f!=NULL)
...
void afficher(GtkWidget *liste)
{
	...
	if(store==NULL)
	{
		...
		f = fopen("/home/benabdlazyz/end/src/ajt.txt","r");
		if(f==NULL)
		{
			return;
		}
...
f=fopen("/home/benabdlazyz/end/src/ajt.txt","r");
tmp=fopen("/home/benabdlazyz/end/src/tmp.txt","w");
 if(f!=NULL) 
{ 
...
fclose(f) ; 
fclose(tmp);
remove("/home/benabdlazyz/end/src/ajt.txt");
rename("/home/benabdlazyz/end/src/tmp.txt","/home/benabdlazyz/end/src/ajt.txt");
}
