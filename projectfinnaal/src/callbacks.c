...
window00=lookup_widget(objet,"window00");

gtk_widget_destroy(window00);
windowacceuil=create_windowacceuil();
gtk_widget_show(windowacceuil);
}
...
gtk_widget_destroy(windowacceuil);
window00=create_window00();
gtk_widget_show(window00);
...
window00=lookup_widget(objet,"window00");
gtk_widget_destroy(window00);
windowespaceclient=create_window3();
gtk_widget_show(windowespaceclient);
}
...
window00=lookup_widget(objet,"window00");
gtk_widget_destroy(window00);
windowespaceclient=create_espace();
gtk_widget_show(windowespaceclient);
}
...
window00=lookup_widget(objet,"window00");
gtk_widget_destroy(window00);
windowespaceclient=create_reservationhotel();
gtk_widget_show(windowespaceclient);
}
...
window00=lookup_widget(objet,"window00");
gtk_widget_destroy(window00);
windowespaceclient=create_gestionvol();
gtk_widget_show(windowespaceclient);
}
...
window00=lookup_widget(objet,"window00");
gtk_widget_destroy(window00);
windowespaceclient=create_Creer();
gtk_widget_show(windowespaceclient);
}
...
void
on_reclamationcs_clicked               (GtkButton       *button,
                                        gpointer         user_data)
{
...
void
on_reservationchiheb_clicked           (GtkButton       *button,
                                        gpointer         user_data)
{

GtkWidget *mesreservations;
mesreservations=create_mesreservations();
gtk_widget_show(mesreservations);

}


void
on_reclamerstiti_clicked               (GtkButton       *button,
                                        gpointer         user_data)
{
...
void
on_reserstiti_clicked                  (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *reservationhotel;
reservationhotel=create_reservationhotel();
gtk_widget_show(reservationhotel);
}


void
on_reclamationimen_clicked             (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *principal1;
principal1=create_principal1();
